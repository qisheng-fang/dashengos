...
const alertVariants = cva(
  "relative w-full rounded-lg border border-oklch(0.92 0.004 286.32) p-4 [&>svg~*]:pl-7 [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-oklch(0.141 0.005 285.823) dark:border-oklch(1 0 0 / 10%) dark:[&>svg]:text-oklch(0.985 0 0)",
  {
    variants: {
      variant: {
