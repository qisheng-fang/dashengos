...
import http.server, json, base64, random, os, time, threading, urllib.parse, socketserver, subprocess
...
class H(http.server.BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if p == '/api/v1/skills/marketplace':
            return self._json({"skills": [], "categories": []})
    ...
    def do_POST(self):
        ...
        if p == '/api/v1/sessions':
            return self._json({'id':'default','title':body.get('title','新会话')})
